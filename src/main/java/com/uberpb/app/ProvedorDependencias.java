...
public final class ProvedorDependencias {
    ...
    public static ContextoAplicacao fornecerContexto() {
        ...
        // RF22 — SERVIÇOS DE NOTIFICAÇÃO E ENTREGA
        ServicoNotificacao servNotificacao = new ServicoNotificacao(repoNotificacao);
        ServicoEntrega servEntrega = new ServicoEntrega(repoUsuario, repoPedido, servLoc, servNotificacao);
