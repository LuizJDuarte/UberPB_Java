...
/**
 * RF24: Comando para entregador recusar um pedido de entrega
 */
public class RecusarPedidoComando implements Comando {

    @Override
    public String nome() {
        return "[Entregador] Recusar Pedido";
    }
    ...
    public void executar(ContextoAplicacao contexto, Scanner scanner) {
        ...
        if (pedidosDisponiveis.isEmpty()) {
            System.out.println("(Nenhum pedido disponível para recusar)");
            System.out.println("====================================\n");
            return;
        }
        ...
        // Recusa o pedido através do serviço
