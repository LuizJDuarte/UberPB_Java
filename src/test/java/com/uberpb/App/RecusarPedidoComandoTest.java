...
public class RecusarPedidoComandoTest {
    ...
    private RecusarPedidoComando comando;
    ...
    void setup() {
        ...
        comando = new RecusarPedidoComando();
    }
    ...
    void recusarPedidoComSucesso() {
        ...
        when(pedido.getTotal()).thenReturn(45.0);
        when(pedido.getStatus()).thenReturn("EM_PREPARO");

        when(servicoPedido.buscarPedidosDisponiveisParaEntregador(any()))
                .thenReturn(List.of(pedido));

        when(servicoEntrega.recusarPedido(any(), any()))
                .thenReturn(true);
        ...
        verify(servicoEntrega).recusarPedido(any(), any());
    }

    @Test
    void cancelarRecusaPedido() {
        ...
        verify(servicoEntrega, never()).recusarPedido(any(), any());
    }
}
